...
export class SyncService {
  ...
  async deletarNaoConfirmadas() {
    ...
    // ⚡ Bolt: Optimize sequential API calls by batching them using Promise.all
    // This reduces N+1 network latency by processing requests concurrently in chunks
    // Expected impact: Processing time reduced by up to ~95% compared to sequential execution.
    const chunkSize = 20;
