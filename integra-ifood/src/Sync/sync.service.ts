...
export class SyncService {
    ...
    async registerUser(payload) {
        ...
        if (codParc == null) {
            ...
            console.log(payload.nome, payload.email, payload.cpf, ddd, numero, String(endereco.cep), endereco.estado, endereco.cidade, endereco.rua, endereco.numero, endereco.bairro, token);
