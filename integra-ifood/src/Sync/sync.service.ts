...
export class SyncService {
  ...
  // ⚡ Bolt: helper to process arrays in chunks to avoid N+1 issues natively without external ESM dependencies
  ...
  async deletarNaoConfirmadas() {
    ...
    // ⚡ Bolt: Optimize by running up to 20 concurrent note cancellations to eliminate N+1 latency natively
    await this.processInChunks(notas, 20, async (row) => {
