...
export class SyncService {
  ...
  async synccurvaProdutoProdutos(authToken: string) {
    ...
    // Optimization: Process updates concurrently with a limit of 20 to improve performance
    // This avoids blocking the loop for each database update sequentially.
