...
export class PrismaService {
  ...
  async getSeparadores() {
    // ⚡ Bolt: Removed unoptimized findMany() that fetched all users just to filter/count them.
    // Using where clause directly to let database do the filtering.
  ...
  async getSolicitacao() {
    // ⚡ Bolt: Using where: { aprovado: false } instead of fetching all records and filtering in JS.
