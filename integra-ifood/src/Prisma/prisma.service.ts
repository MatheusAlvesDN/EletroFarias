...
export class PrismaService {
  ...
  async getSeparadores() {
    // ⚡ Bolt: Removed redundant prisma.user.findMany() that fetched all users just for logging, and used the targeted query directly.
  ...
  async getSolicitacao() {
    // ⚡ Bolt: Fetch only unapproved solicitations directly from the database instead of fetching all and filtering in memory
