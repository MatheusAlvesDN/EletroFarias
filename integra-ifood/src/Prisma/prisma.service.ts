...
export class PrismaService {
  ...
  async getSeparadores() {
    // ⚡ Bolt: Removed unnecessary prisma.user.findMany() call that was fetching all users into memory just for a console.log
  ...
  async getSolicitacao() {
    // ⚡ Bolt: Use Prisma's where clause to filter database side instead of in memory to avoid N+1 and large memory consumption
