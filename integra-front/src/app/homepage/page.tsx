      ...
      <div className="w-full max-w-md">
        <div className="bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
          ...
          <div className="px-8 pb-8 pt-2">
            ...
            <a
              href="/download"
              className="w-full inline-flex items-center justify-center rounded-lg border-2 border-slate-200 bg-transparent px-4 py-2.5 text-slate-700 font-medium hover:bg-slate-50 hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-200 transition-colors"
            >
              <svg className="w-5 h-5 mr-2 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
