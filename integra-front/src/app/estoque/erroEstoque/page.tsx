...
function AjusteDialog({
    ...
    // -------- normalização de cod barras (igual seu padrão) ----------
    ...
    const handleEnviarContagem = useCallback(async () => {
        ...
        try {
            ...
            // ✅ mantém o padrão "valor" como parâmetro
            // Se seu backend NÃO usar codProd aqui, remova "&codProd=..."
                                ...
                                <Table size="small">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell width={240}><b>Ações</b></TableCell>
                                        </TableRow>
                                    </TableHead>
