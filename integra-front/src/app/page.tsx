  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link
          href="/download"
          className="mt-4 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-cyan-700 px-4 py-3 text-white font-bold shadow-md hover:bg-cyan-800 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
