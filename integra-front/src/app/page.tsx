    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
         ...
         <Link
          href="/download"
          className="mt-3 inline-flex h-11 w-full items-center justify-center rounded-lg bg-cyan-700 px-4 text-white font-bold no-underline hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow transition-colors"
        >
          BAIXAR APK
        </Link>
      </div>
