  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link
          href="/download"
          className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-teal-700 px-4 py-2.5 text-white font-medium shadow hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors"
        >
          <svg
            className="h-5 w-5"
            fill="none"
