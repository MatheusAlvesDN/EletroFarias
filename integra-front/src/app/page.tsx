  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link
          href="/download"
          className="w-full inline-flex items-center justify-center h-[44px] mt-3 px-4 rounded-lg bg-cyan-700 text-white font-bold hover:bg-cyan-800 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
        >
          <svg
