  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link
          href="/download"
          className="inline-flex items-center justify-center w-full h-11 mt-3 px-4 rounded-lg bg-cyan-700 text-white font-bold hover:bg-cyan-800 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
        >
          <svg
          ...
          >
            <path
              ...
              d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M12 3v13.5M12 16.5l3.75-3.75M12 16.5L8.25 12.75"
            />
          </svg>
          BAIXAR APK
        </Link>
