  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link
          href="/download"
          className="w-full mt-3 inline-flex items-center justify-center rounded-lg bg-cyan-700 px-4 py-2.5 text-white font-bold shadow hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-cyan-500"
          aria-label="Ir para página de download do aplicativo Android"
        >
          BAIXAR APK
        </Link>
      </div>
