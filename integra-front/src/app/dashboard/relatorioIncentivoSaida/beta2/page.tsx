      ...
      <header className="bg-emerald-700 text-white shadow-lg sticky top-0 z-30">
        <div className="w-full max-w-[1920px] mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-end">
            ...
            <button onClick={() => { Promise.all(activeMonths.map((m) => refreshMonth(m))); }} className="flex items-center gap-2 px-4 py-2 text-sm font-bold bg-white/10 hover:bg-white/15 rounded-lg transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 shadow-sm border border-emerald-500" title="Atualizar dados">
