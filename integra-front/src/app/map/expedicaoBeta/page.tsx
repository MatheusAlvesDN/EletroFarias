...
export default function Page() {
    ...
    useEffect(() => {
        ...
        setToken(t); // pode ser null e tá tudo bem
    }, []);
    ...
    // ✅ polling sempre ativo (mesmo sem login)
    useEffect(() => {
        ...
        try {
            ...
            if (!fsEl) {
                ...
                try {
                    ...
                    // ignora se não suportar / não permitir
                }
                            ...
                            <>
                                ...
                                {filtered.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        >
                                            {/* ✅ Scroller rotacionado: largura/altura invertidas + rotação 90° */}
                                            <Box
                                                sx={
                                                    fullScreen
                                                        ? {
