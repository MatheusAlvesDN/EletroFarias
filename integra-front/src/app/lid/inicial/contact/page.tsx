            ...
            <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-stone-950/80 backdrop-blur-md border-b border-outline-variant/20">
                <div className="flex justify-between items-center px-8 py-4 max-w-full mx-auto">
                    ...
                    <div className="hidden md:flex items-center space-x-10">
                        ...
                        <Link href="/lid/inicial/projects" className="font-label tracking-wide font-medium uppercase text-xs text-on-surface-variant hover:text-primary transition-colors">Projetos</Link>
                        ...
                        <Link href="/lid/inicial/contact" className="font-label tracking-wide font-bold uppercase text-xs text-primary border-b-2 border-primary pb-1">Contato</Link>
                    </div>
