              ...
              {columns.map((col) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Box display="flex" flexDirection="column" gap={2} sx={{ flexGrow: 1, overflowY: "auto", minHeight: "150px", "&::-webkit-scrollbar": { width: 0 } }}>
                      {columnLeads.map((l) => (
                        <Card
                          key={l.id}
                          draggable
                        ...
                        >
                          <CardContent sx={{ p: "16px !important" }}>
                            <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={1.5}>
                              ...
                              <IconButton size="small" sx={{ mt: -0.5, mr: -1 }} onClick={(e) => e.stopPropagation()}>
