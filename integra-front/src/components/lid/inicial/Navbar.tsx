    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-stone-950/80 backdrop-blur-md border-b border-outline-variant/20">
            <div className="flex justify-between items-center px-8 py-4 max-w-full mx-auto">
                ...
                {/* Logo Customizado em CSS */}
                <Link href="/lid/inicial/home" className="flex items-center gap-2 md:gap-3 text-primary hover:opacity-80 transition-opacity">
                    <div className="relative w-8 h-8 md:w-10 md:h-10">
                        <div className="absolute inset-0 border-2 border-primary rounded-circle"></div>
                        <div className="absolute h-[120%] w-[2px] bg-primary top-[-10%] left-2/3 -translate-x-1/2"></div>
                    </div>
                    <div className="text-2xl md:text-3xl font-medium tracking-tight flex items-baseline">
                        Lid<span className="text-secondary text-3xl md:text-4xl leading-none">.</span>
                    </div>
            ...
            {mobileMenuOpen && (
                <div className="md:hidden bg-white dark:bg-stone-950 border-b border-outline-variant/20 px-8 py-4 flex flex-col space-y-4">
