...
export const MENU_SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'CONTAGEM', path: '/inventory/contagem', icon: <FormatListNumberedIcon />, rolesAllowed: ['ADMIN', 'MANAGER', 'CONTADOR'] },
      { label: 'RECONTAGEM', path: '/inventory/recontagem', icon: <RestartAltIcon />, rolesAllowed: ['ADMIN', 'MANAGER', 'CONTADOR'] },
      { label: 'TERCEIRA CONTAGEM', path: '/inventory/terceira_contagem', icon: <Looks3Icon />, rolesAllowed: ['ADMIN', 'MANAGER', 'CONTADOR'] },
      { label: 'PRODUTOS NÃO LOCALIZADOS', path: '/inventory/inventorynotcount', icon: <ReportProblemIcon />, rolesAllowed: ['ADMIN', 'MANAGER', 'CONTADOR'] },
      { label: 'PRODUTOS CONTADOS', path: '/inventory/inventorycount', icon: <DoneAllIcon />, rolesAllowed: ['ADMIN', 'MANAGER'] },
    ],
  },
  {
    id: 'inventoryAdmin',
    ...
    items: [
      { label: 'CONTAGENS REALIZADAS', path: '/inventory/contagens', icon: <ReceiptLongIcon />, rolesAllowed: ['ADMIN', 'MANAGER'] },
      { label: 'AJUSTE DE INVENTÁRIO', path: '/inventory/ajustar', icon: <TuneIcon />, rolesAllowed: ['ADMIN', 'MANAGER'] },
      { label: 'INCLUIR NOTA DE VENDA', path: '/inventory/notanegativa', icon: <ReceiptIcon />, rolesAllowed: ['ADMIN', 'MANAGER'] },
      { label: 'INCLUIR NOTA DE COMPRA', path: '/inventory/notapositiva', icon: <ReceiptIcon />, rolesAllowed: ['ADMIN', 'MANAGER'] },
